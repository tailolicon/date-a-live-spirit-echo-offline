...
--]]
c2s.ARENA_REQ_ARENA_RECORD = 18306
...
--[[
	[1] = {--ReqTakeServerProgressReward
		[1] = 'int32':activityId
		[2] = 'string':progress
	}
--]]
c2s.ACTIVITY2_REQ_TAKE_SERVER_PROGRESS_REWARD = 9427
...
--]]
c2s.ARENA_REQ_ARENA_LAST_DATA = 18303
...
--[[
	[1] = {--ReqSendGiftRank
		[1] = 'int32':heroId	[精灵id]
		[2] = 'int32':itemNum	[赠送礼物数量]
	}
--]]
c2s.RANK_REQ_SEND_GIFT_RANK = 9602
...
--[[
	[1] = {--ReqGiftRankInfo
		[1] = 'int32':rankType	[1:人气总榜;2:个人贡献榜;3:个人战力榜]
		[2] = 'int32':heroId	[精灵id,rankType为2或者3时候需要]
	}
--]]
c2s.RANK_REQ_GIFT_RANK_INFO = 9601
...
--[[
	[1] = {--ReqSupportActivityData
		[1] = 'int32':activityId
	}
--]]
c2s.ACTIVITY2_REQ_SUPPORT_ACTIVITY_DATA = 9428
...
--[[
	[1] = {--ReqMopUpReward
		...
		[2] = 'int32':mopUpNum	[扫荡的次数]
	}
--]]
c2s.DUNGEON_REQ_MOP_UP_REWARD = 1833
...
--[[
	[1] = {--ReqVoucherSevenDayInfo
	}
--]]
c2s.ACTIVITY_REQ_VOUCHER_SEVEN_DAY_INFO = 5403
...
--[[
	[1] = {--ReqAngelStrengthen
		[1] = 'string':heroId
		[2] = 'int32':skillType	[技能类型]
		[3] = 'int32':costType	[消耗方式 1.needCost,2.needCost2]
	}
--]]
c2s.HERO_REQ_ANGEL_STRENGTHEN = 1051
...
--[[
	[1] = {--ReqRechargeExchange
		[1] = 'int32':rechargeId
		[2] = 'string':extinfo	[额外信息 json]
	}
--]]
c2s.RECHARGE_REQ_RECHARGE_EXCHANGE = 4390
...
--[[
	[1] = {--ReqArenaOverMsg
		[1] = {--repeated ArenaHeroResult
			[1] = 'int32':selfHero	[己方英雄cid]
			[2] = 'int32':enemyHero	[对方英雄cid]
			[3] = 'bool':success	[是否胜利]
		},
	}
--]]
c2s.DUNGEON_REQ_ARENA_OVER = 1835
...
--[[
	[1] = {--ReqMatchArenaPlayer
	}
--]]
c2s.ARENA_REQ_MATCH_ARENA_PLAYER = 18305
...
--[[
	[1] = {--OperateFormation
		[1] = 'int32':formationType	[1-主阵型,2-组队,3-竞技场    //1-主阵型,2-组队,3-竞技场]
		[2] = 'string':sourceHeroId
		[3] = 'string':targetHeroId
	}
--]]
...
--[[
	[1] = {--ReqFormationBackupUse
		[1] = 'int32':id
		[2] = 'int32':formationType	[1-主阵型,2-组队,3-竞技场    //1-主阵型,2-组队,3-竞技场]
	}
--]]
...
--[[
	[1] = {--ReqGetAllActivity3
	}
--]]
c2s.ACTIVITY3_REQ_GET_ALL_ACTIVITY3 = 12001
...
--]]
c2s.ARENA_REQ_ARENA_INFO = 18301
...
--[[
	[1] = {--ReqElementTrainRank
		[1] = 'int32':id	[排行榜类型,传ElementTrainDungeon.csv#id]
	}
--]]
c2s.ACTIVITY3_REQ_ELEMENT_TRAIN_RANK = 12002
...
--[[
	[1] = {--ReqElementTrainInfo
	}
--]]
c2s.ACTIVITY3_REQ_ELEMENT_TRAIN_INFO = 12003
...
--[[
	[1] = {--ReqAnnihilate
		[1] = 'int32':levelCid	[关卡cid]
		[2] = 'int32':quickCount	[ 快速战斗次数]
		[3] = 'bool':isDuelMod	[ 决斗模式]
	}
--]]
c2s.DUNGEON_REQ_ANNIHILATE = 1834
...
--[[
	[1] = {--NewSubmitActivity
		...
		[2] = 'repeated int32':activitEntryId	[ 活动条目ID]
		[3] = 'string':extendData	[ 扩展数据]
	}
--]]
...
--[[
	[1] = {--ReqVoucherSevenDayGetReward
		[1] = 'int32':id	[领取的奖励id]
	}
--]]
c2s.ACTIVITY_REQ_VOUCHER_SEVEN_DAY_GET_REWARD = 5404
...
--]]
c2s.ARENA_REQ_ARENA_RANK_LIST = 18302
...
--]]
c2s.SUMMON_REQ_SET_WISH_ID = 3328
