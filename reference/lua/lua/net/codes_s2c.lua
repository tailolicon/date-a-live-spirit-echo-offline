...
--[[
	[1] = {--ResUpgradePet
		[1] = 'int32':type	[1完成升级,2完成升阶]
	}
--]]
s2c.PET_RES_UPGRADE_PET = 9902
		...
		[1] = {--LadderInfo
			...
			[6] = {--RspLadderCycle
				...
				[6] = {--repeated HeroInfo
					...
					[29] = {--repeated AngeStrengthenInfo
						[1] = 'int32':skillType
						[2] = 'int32':lv
					},
				},
...
--]]
s2c.ACTIVITY_RES_VOUCHER_SEVEN_DAY_GET_REWARD = 5404
...
--[[
	[1] = {--RspArenaRankList
		[1] = {--repeated RspArenaRank
			[1] = 'int32':pid	[玩家id]
			[2] = 'string':pName	[玩家名字]
			[3] = 'int32':segment	[段位]
			[4] = 'int32':arenaScore	[竞技场分]
			[5] = 'int32':rank	[排名,0则为未上榜]
			[6] = 'int32':headId	[头像]
			[7] = 'int32':level	[等级]
			[8] = 'int32':fightPower	[阵型战力]
		},
		[2] = {--RspArenaRank
			[1] = 'int32':pid	[玩家id]
			[2] = 'string':pName	[玩家名字]
		...
		[6] = {--repeated ArenaTopRankHistory
			[1] = 'int32':index	[周期计数]
			[2] = {--repeated ArenaTopHistoryInfo
				[1] = {--RspArenaRank
					[1] = 'int32':pid	[玩家id]
					[2] = 'string':pName	[玩家名字]
					[3] = 'int32':segment	[段位]
				...
				[3] = {--ArenaHeroInfo
					[1] = 'int32':cid	[英雄cid]
					[2] = 'int32':skin	[英雄皮肤cid]
					[3] = 'int32':lv	[英雄等级]
				},
				[4] = 'int32':unionId	[帮会id]
				[5] = 'string':unionName	[帮会名称]
			},
		},
		[7] = {--repeated RspArenaRank
			[1] = 'int32':pid	[玩家id]
			[2] = 'string':pName	[玩家名字]
			[3] = 'int32':segment	[段位]
			[4] = 'int32':arenaScore	[竞技场分]
...
--]]
s2c.ARENA_RSP_ARENA_RANK_LIST = 18302
...
--]]
s2c.DUNGEON_RESP_ANNIHILATE = 1834
...
--]]
s2c.RANK_RES_SEND_GIFT_RANK = 9602
...
--]]
s2c.ACTIVITY3_RES_ELEMENT_TRAIN_RANK = 12002
...
--[[
	[1] = {--Summon
		...
		[11] = 'int32':sixGuaranteesCount	[六星大保底次数]
		[12] = 'int32':wishId	[心愿卡id(为0代表该卡池没有心愿)    //心愿卡id(为0代表该卡池没有心愿)]
	}
--]]
...
--[[
	[1] = {--ResSetWishId
		[1] = 'int32':poolType	[卡池]
		[2] = 'int32':summonPoolId	[心愿id(0代表取消心愿)    //心愿id(0代表取消心愿)]
	}
--]]
s2c.SUMMON_RES_SET_WISH_ID = 3328
...
--]]
s2c.ARENA_RSP_MATCH_ARENA_PLAYER = 18305
...
--[[
	[1] = {--ResSupportActivityData
		[1] = 'repeated string':taken
		[2] = 'string':progress
		[3] = 'int32':activityId
	}
--]]
s2c.ACTIVITY2_RES_SUPPORT_ACTIVITY_DATA = 9428
...
--]]
s2c.ARENA_RSP_ARENA_LAST_DATA = 18303
...
--[[
	[1] = {--RspArenaRecord
		[1] = {--repeated ArenaBattleRecord
			[1] = 'int32':pid	[玩家id]
			[2] = 'string':pName	[玩家名字]
			[3] = {--repeated ArenaBattleRecordHero
				[1] = {--ArenaHeroInfo
					[1] = 'int32':cid	[英雄cid]
					[2] = 'int32':skin	[英雄皮肤cid]
					[3] = 'int32':lv	[英雄等级]
			...
			[4] = 'int32':arenaScore	[竞技场分变化]
			[5] = 'bool':attack	[是否为进攻方]
			[6] = 'int32':headId	[头像]
			[7] = 'int32':level	[等级]
		},
	}
--]]
s2c.ARENA_RSP_ARENA_RECORD = 18306
...
--[[
	[1] = {--SummonPanelInfo
		[1] = {--repeated SummonInfo
			...
			[16] = 'int32':sixGuaranteesCount	[六星大保底次数]
			[17] = 'int32':wishId	[心愿卡id(为0代表该卡池没有心愿)    //心愿卡id(为0代表该卡池没有心愿)]
		},
		[2] = {--SummonNoob
			[1] = 'bool':noobStatus	[ 功能是否可用]
			[2] = 'int32':endTime	[ 结束时间]
...
--[[
	[1] = {--RespRechargeExchange
	}
--]]
s2c.RECHARGE_RESP_RECHARGE_EXCHANGE = 4390
...
--[[
	[1] = {--ResGiftRankInfo
		[1] = {--repeated TotalRakInfo
			[1] = 'int32':rank	[排名]
			[2] = 'int64':score	[分数]
			[3] = 'int32':heroId	[精灵id]
		},
		[2] = {--repeated PersonalRakInfo
			[1] = 'int32':rank	[排名]
			[2] = 'int64':score	[分数]
			[3] = 'int32':heroId	[精灵id,rankType为2或者3时候需要]
			[4] = 'int32':playerId	[玩家id]
			[5] = 'string':name	[玩家名字]
			[6] = 'int32':lv	[等级]
			[7] = 'int32':portraitCid	[头像id]
			[8] = 'int32':portraitFrameCid	[头像框id]
		},
		[3] = {--repeated PersonalRakInfo
			[1] = 'int32':rank	[排名]
			[2] = 'int64':score	[分数]
			[3] = 'int32':heroId	[精灵id,rankType为2或者3时候需要]
			[4] = 'int32':playerId	[玩家id]
		...
		[4] = 'int32':rankType	[1:人气总榜;2:个人贡献榜;3:个人战力榜]
	}
--]]
s2c.RANK_RES_GIFT_RANK_INFO = 9601
...
--[[
	[1] = {--RspArenaInfo
		[1] = {--ArenaInfo
			[1] = 'int32':step	[活动阶段(0-准备期;1-进行期;2-结算期)    //活动阶段(0-准备期;1-进行期;2-结算期)]
			[2] = 'int32':nextStepTime	[进入下阶段的具体时刻(秒)    //进入下阶段的具体时刻(秒)]
			[3] = {--RspArenaCycle
				[1] = 'int32':segment	[段位]
				[2] = 'int32':arenaScore	[竞技场分]
				[3] = 'repeated int32':regionBuffs	[区域buff]
			},
			[4] = 'bool':showTips	[是否新周期提示]
		},
	}
--]]
s2c.ARENA_RSP_ARENA_INFO = 18301
...
--[[
	[1] = {--NewResultSubmitActivity
		[1] = 'int32':activityid	[提交的活动ID]
		[2] = 'repeated int32':activitEntryId	[提交的活动条目ID]
		[3] = {--repeated RewardsMsg
			[1] = 'int32':id
			[2] = 'int32':num
		},
...
--]]
s2c.ACTIVITY3_RES_GET_ALL_ACTIVITY3 = 12001
...
--[[
	[1] = {--RespArenaOverMsg
		[1] = 'int32':battleScore	[战斗得分]
	}
--]]
s2c.DUNGEON_RESP_ARENA_OVER = 1835
...
--]]
s2c.DUNGEON_RESP_MOP_UP_REWARD = 1833
...
--[[
	[1] = {--ResElementTrainInfo
		[1] = {--repeated ElementTrainHero
			[1] = 'int32':heroId	[英雄cid]
			[2] = 'int32':fatigue	[英雄当前累计的疲劳值]
		},
		[2] = {--repeated ElementTrainDungeon
			[1] = 'int32':elementTrainDungeonId	[章节id(ElementTrainDungeon.csv#id)    //章节id(ElementTrainDungeon.csv#id)]
			[2] = 'repeated int32':dungeonLevelIdList	[已经通关的副本id(ElementTrainDungeon.csv#dungeonID)    //已经通关的副本id(ElementTrainDungeon.csv#dungeonID)]
		},
	}
--]]
s2c.ACTIVITY3_RES_ELEMENT_TRAIN_INFO = 12003
...
--[[
	[1] = {--ResAngelStrengthen
		[1] = 'string':heroId
		[2] = 'int32':skillType	[技能类型]
		[3] = 'int32':lv	[当前强化等级]
	}
--]]
s2c.HERO_RES_ANGEL_STRENGTHEN = 1051
...
--]]
s2c.ACTIVITY2_RES_TAKE_SERVER_PROGRESS_REWARD = 9427
...
--[[
	[1] = {--ResVoucherSevenDayInfo
		[1] = 'int32':activityId	[活动id (若为-1代表当前处于活动cd期)    //活动id (若为-1代表当前处于活动cd期)]
		[2] = 'int64':endTime	[活动结束时间 (秒级时间戳)    //活动结束时间 (秒级时间戳)]
		[3] = 'repeated int32':alreadyClaimedId	[已领取的奖励id]
		[4] = 'repeated int32':payAmountByDay	[每日的充值金额,依次为第1天.第二天........第n天]
		[5] = 'int32':curDay	[当前是第几天(1~7)    //当前是第几天(1~7)]
		[6] = 'int64':nextOpenTime	[下次开启时间  (秒级时间戳)(若为0代表没有下期活动了)    //下次开启时间  (秒级时间戳)(若为0代表没有下期活动了)]
	}
--]]
s2c.ACTIVITY_RES_VOUCHER_SEVEN_DAY_INFO = 5403
