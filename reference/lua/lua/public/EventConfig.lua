...
EV_LOGIN_UPDATESERVERNAME = "ev_login_updateservername"   -- 登录界面更新服务器显示名称
 ...
 EV_GAMESERVER_REFRESH = "ev_game_server_refresh"        -- 游戏服列表刷新
-- 阵容
...
EV_HERO_ANGEL_STRENGTHEN = "EV_HERO_ANGEL_STRENGTHEN" --天使强化更新
...
EV_RECV_TRANSLATE = "EV_RECV_TRANSLATE"             --翻译返回
...
EV_BAG_PET_UPDATE = "ev_bag_pet_update"    -- 使用道具成功
...
EV_SUMMON_WISH_CHANGE = "EV_SUMMON_WISH_CHANGE"    -- 心愿卡设置变更
...
EV_HERO_RANK_UPDATE = "EV_HERO_RANK_UPDATE" --精灵打榜
EV_ACTIVITY3_DATA_UPDATE = "EV_ACTIVITY3_DATA_UPDATE" --V3版本活动数据更新

EV_ACTIVITY_ELEMENT_TRAIL_RANK_UPDATE = "EV_ACTIVITY_ELEMENT_TRAIL_RANK_UPDATE" --元素试炼排行数据刷新
EV_ACTIVITY_ELEMENT_TRAIL_INFO_UPDATE = "EV_ACTIVITY_ELEMENT_TRAIL_INFO_UPDATE" --元素试炼信息刷新
--广告
...
EV_AREAN_LAST_RANK_DATA  = "EV_AREAN_LAST_RANK_DATA"  --竞技场上期结算信息

-- 宠物事件

EV_PET_LEVEUP = "EV_PET_LEVEUP" --宠物升级

EV_PET_CHANGE = "EV_PET_CHANGE" --宠物装配更换卸载


-- 代金卷
--连充界面信息更新
EV_VOUCHER_SEVEN_DAY_DATA_UPDATE = "EV_VOUCHER_SEVEN_DAY_DATA_UPDATE"
--转盘信息更新
-- EV_VOUCHER_TURNTABLE_DATA_UPDATE = "EV_VOUCHER_TURNTABLE_DATA_UPDATE"
--抽奖返回
-- EV_VOUCHER_VOUCHER_LOTTERY       = "EV_VOUCHER_VOUCHER_LOTTERY"
--连充领奖
EV_VOUCHER_SEVEN_DAY_GET_REWARD  = "EV_VOUCHER_SEVEN_DAY_GET_REWARD"