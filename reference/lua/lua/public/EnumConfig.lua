...
EC_SummonType = {
    ...
    CLOTHESE_2 = 16, -- 时装召唤2
    CLOTHESE_3 = 17, -- 时装召唤3
    CONTRACT_ROLE  = 30, --契约卡池角色
    CONTRACT_EQUIP = 31, --契约卡池装备
...
EC_ActivityType = {
    ...
    LUXURY_FIRST_CHARGE = 12,  --2024豪华首充
    -- CRAZY_GIVE = 13 ,  --疯狂送现金

    -- VOUCHER_TURNTABLE = 14 ,  --代金券转盘
    VOUCHER_SEVEN_DAY = 15 ,  --代金连充好礼
    RANK2026 = 16 ,  --打榜活动
}
...
EC_ActivityType2 = {
    ...
    FULL_SERVER_TASK_ACTIVITY = 111,-- 任务带全服的任务
