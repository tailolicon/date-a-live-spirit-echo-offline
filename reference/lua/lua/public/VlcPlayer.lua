...
function VlcPlayer:init()
    ...
    self.video:addMEListener(EventTag, function(node)
        if self.filePath == "video0/loginPart1.mp4" or self.filePath == "video0/loginPart6.mp4" then
...
function VlcPlayer:initSubTitle( filePath )
    local function initLabel( )
        ...
        self.subTitleLabel:setFontSize(26)
        self.subTitleLabel:setDimensions(GameConfig.WS.width, 0)
