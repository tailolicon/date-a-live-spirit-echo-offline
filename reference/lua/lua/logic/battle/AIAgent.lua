...
-- 施放指定类型技能
local ReleaseSpecificTypeSkillBevNode = myClass("ReleaseSpecificTypeSkillBevNode", BaseNode)

function ReleaseSpecificTypeSkillBevNode:onExecute()
    self.host_:act_useSpecifiedSkill(self.id_,self.cfg_.SkillType)
end
