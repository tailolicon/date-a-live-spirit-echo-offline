...
eAttrType.ATTR_2131     = 2131    --备用属性
eAttrType.ATTR_2132     = 2132    --备用属性
eAttrType.ATTR_2133     = 2133    --备用属性
eAttrType.ATTR_2134     = 2134    --备用属性
eAttrType.ATTR_2135     = 2135    --备用属性
eAttrType.ATTR_2136     = 2136    --备用属性
eAttrType.ATTR_2137     = 2137    --备用属性
eAttrType.ATTR_2138     = 2138    --备用属性
eAttrType.ATTR_2139     = 2139    --备用属性
eAttrType.ATTR_2140     = 2140    --备用属性
eAttrType.ATTR_2141     = 2141    --备用属性
eAttrType.ATTR_2142     = 2142    --备用属性
eAttrType.ATTR_2143     = 2143    --备用属性
eAttrType.ATTR_2144     = 2144    --备用属性
eAttrType.ATTR_2145     = 2145    --备用属性
eAttrType.ATTR_2146     = 2146    --备用属性
eAttrType.ATTR_2147     = 2147    --备用属性
eAttrType.ATTR_2148     = 2148    --备用属性
eAttrType.ATTR_2149     = 2149    --备用属性
eAttrType.ATTR_2150     = 2150    --备用属性
...
enum.eRoleType = {
    ...
    Team     = 4,    --组队角色
    Trap     = 6,    --陷阱
    Hero_Arena = 10,  --竞技场英雄 ，只在创建队伍角色时使用
}
...
enum.eBFEffectType =
{
    ...
    ET_REMOVE_TARBUFFER     = 19,       -- 移除指定目标buff
}
...
---
    ...
    --
    EVENT_AUTO_FIGHT_STATE_CHANGE        = "auto_fight_state_change"        , --自动状态度状态变更
}
