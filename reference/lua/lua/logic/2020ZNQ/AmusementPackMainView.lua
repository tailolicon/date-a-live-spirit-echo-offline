...
function AmusementPackMainView:initUI(ui)
    ...
    if Utils:getZNQUISkin() == 1 then 
        self.Image_map:setTexture("ui/activity/znq_yly_global/mainUi/015_1.png")
    end
    --动态添加乐园手册文本
    local label = TFLabel:create()
    self.Panel_miniMap:addChild(label,1)
    label:setFontName("font/fangzheng_zhunyuan.ttf")
    label:setFontSize(18)
    label:enableStroke(ccc3(89, 120, 232), 1)
    label:setAnchorPoint(ccp(0 , 0.5))
    label:setPosition(17 , 150)
    label:setFontColor(ccc3(255 , 255, 255))
    label:setTextById(13202076)
