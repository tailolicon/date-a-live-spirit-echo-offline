...
function MaokaFormulaListView:ctor( formulaId )
	...
	self:init("lua.uiconfig.secondary.uiconfig_zn.activity.formulaList")
end
...
function MaokaFormulaListView:initUI( ui )
	...
	self.Panel_levelUp.Image_normal.Label_name = TFDirector:getChildByPath(self.Panel_levelUp.Image_normal,"Label_name")
	self.Panel_levelUp.Image_select.Label_name = TFDirector:getChildByPath(self.Panel_levelUp.Image_select,"Label_name")

    self.Panel_levelUp.Image_normal.Label_name:setTextById(13316907) --饮品列表
    self.Panel_levelUp.Image_select.Label_name:setTextById(13316907) --饮品列表


	self.Panel_compose            = TFDirector:getChildByPath(ui,"Panel_compose")
	self.Panel_compose.Label_name = TFDirector:getChildByPath(self.Panel_compose,"Label_name")
	self.Panel_compose.Label_name:setTextById(13316908) --饮品研制
	...
	self.Label_formulaList_1  = TFDirector:getChildByPath(self.Button_levelUp,"Label_formulaList_1")
    
	self.Label_1  = TFDirector:getChildByPath(self.panel_right,"Label_1")
	self.Label_2  = TFDirector:getChildByPath(self.panel_right,"Label_2")
    self.Label_1:setTextById(13316910) --总速度
    self.Label_2:setTextById(13316909)  --拥有心得
    self.Label_formulaList_1:setTextById(13316906) --饮品升级
...
function MaokaFormulaListView:updateItem( item, cfg)
	...
	local Label_1 = TFDirector:getChildByPath(Image_unlock,"Label_1")
	Label_1:setTextById(450010) --未解锁
