...
function MaokaTaskView:ctor( ... )
	...
	self:init("lua.uiconfig.secondary.uiconfig_zn.activity.taskView")
end
...
function MaokaTaskView:initUI( ui )
	...
	self.Panel_yinye.Image_normal.Label_name = TFDirector:getChildByPath(self.Panel_yinye.Image_normal,"Label_name")
	self.Panel_yinye.Image_select.Label_name = TFDirector:getChildByPath(self.Panel_yinye.Image_select,"Label_name")

	self.Panel_daily.Image_normal.Label_name = TFDirector:getChildByPath(self.Panel_daily.Image_normal,"Label_name")
	self.Panel_daily.Image_select.Label_name = TFDirector:getChildByPath(self.Panel_daily.Image_select,"Label_name")

	--language
    self.Panel_yinye.Image_normal.Label_name:setTextById(13316920) --营业任务
    self.Panel_yinye.Image_select.Label_name:setTextById(13316920) --营业任务

    self.Panel_daily.Image_normal.Label_name:setTextById(303068) --每日任务
	self.Panel_daily.Image_select.Label_name:setTextById(303068) --每日任务
    ...
    --language set
	self.Panel_content_yinye_Label_tip= TFDirector:getChildByPath(self.Panel_content_yinye,"Label_tip")
	self.Panel_content_yinye_Label_tip2= TFDirector:getChildByPath(self.Panel_content_yinye,"Label_tip2")
	self.Panel_content_yinye_Label_tip1= TFDirector:getChildByPath(self.Panel_content_yinye,"Label_tip1")
    self.Panel_content_yinye_Label_tip:setTextById(13316918) --当前营业额
    self.Panel_content_yinye_Label_tip1:setTextById(13316919) --更新倒计时
    self.Panel_content_yinye_Label_tip2:setTextById(13316917) --营业额目标

	self.Panel_content_Label_tip = TFDirector:getChildByPath(self.Panel_content,"Label_tip")
    self.Panel_content_Label_tip:setTextById(13317153) --每日零点自动刷新

	self.Panel_content_Label_btn = TFDirector:getChildByPath(self.Panel_content,"Label_btn")

    self.Panel_content_Label_btn:setTextById(13317154) --立刻刷新
...
function MaokaTaskView:updateTaskItem( item, data )
	...
	local Button_make_name = TFDirector:getChildByPath(Button_make,"Label_taskView_1")
	local Button_tijiao_name = TFDirector:getChildByPath(Button_tijiao,"Label_taskView_1")
	local Button_get_name = TFDirector:getChildByPath(Button_get,"Label_taskView_1")
	local Image_geted_name = TFDirector:getChildByPath(Image_geted,"Label_taskView_1")

	Button_make_name:setTextById(252008) --制作
	Button_tijiao_name:setTextById(100000130) --提交
	Button_get_name:setTextById(700013) --领取
	Image_geted_name:setTextById(270491)  --已领取
	...
	Label_des:setTextById(itemInfo.extendData.des2)
	Label_name:setTextById(itemInfo.details)
...
function MaokaTaskView:updateJiachengItem( item, data )
	...
	local Panel_remai_Label_1 = TFDirector:getChildByPath(Panel_remai,"Label_1")
	local Panel_remai_Label_2 = TFDirector:getChildByPath(Panel_remai,"Label_2")
    Panel_remai_Label_1:setTextById(13316914) --查看女仆加成
    Panel_remai_Label_2:setTextById(13316915) --查看女仆加成


	local Panel_maomi_Label_2 = TFDirector:getChildByPath(Panel_maomi,"Label_2")
    Panel_maomi_Label_2:setTextById(13316916) --猫咪营收速度：
