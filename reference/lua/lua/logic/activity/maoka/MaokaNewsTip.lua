...
function MaokaNewsTip:ctor( ... )
	...
	self:init("lua.uiconfig.secondary.uiconfig_zn.activity.newsTip")
end
...
--language set
    ...
    -- self.Label_title:setTextById() --todo公示栏
    -- self.Label_1:setTextById() --todo公示栏
    -- self.Label_2:setTextById() --todo公示栏
    -- self.Label_3:setTextById() --todo公示栏
