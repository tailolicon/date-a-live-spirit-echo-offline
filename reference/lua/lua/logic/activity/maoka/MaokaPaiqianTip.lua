...
function MaokaPaiqianTip:ctor( taskId )
	...
	self.choiseList = {}
	self:init("lua.uiconfig.secondary.uiconfig_zn.activity.paiqianTip")
end
...
--language set
    ...
    self.Button_auto_name = TFDirector:getChildByPath(self.Button_auto,"Label_paiqianTip_1")
    self.Button_start_name = TFDirector:getChildByPath(self.Button_start,"Label_paiqianTip_1")

    self.Button_auto_name:setTextById(13317156)--一键派遣
    self.Button_start_name:setTextById(2101024)--出发
    

    self.Label_title = TFDirector:getChildByPath(self.Panel_base,"Label_title")
    self.Label_tip12 = TFDirector:getChildByPath(self.Panel_base,"Label_tip12")
    -- self.Label_2 = TFDirector:getChildByPath(self.Panel_base,"Label_2")
    -- self.Label_3 = TFDirector:getChildByPath(self.Panel_base,"Label_3")
    self.Label_title:setTextById(13410017) --派遣
    self.Label_tip12:setTextById(13317155) --点击上阵位，放入探险猫咪
...
function MaokaPaiqianTip:updateItem( item, data )
	...
	local Image_tuijian_Label_1 = TFDirector:getChildByPath(Image_tuijian,"Label_1")
	local Image_working_Label_2 = TFDirector:getChildByPath(Image_working,"Label_2")
    Image_tuijian_Label_1:setTextById(14300377)  --推荐
    Image_working_Label_2:setTextById(13317157)  --派遣中
