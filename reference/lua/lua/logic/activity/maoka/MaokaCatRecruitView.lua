...
function MaokaCatRecruitView:ctor( ... )
	...
	self:init("lua.uiconfig.secondary.uiconfig_zn.activity.catRecruit")
end
...
function MaokaCatRecruitView:initUI( ui )
	...
	self.Panel_base = TFDirector:getChildByPath(ui,"Panel_base")
		local Image_2 = TFDirector:getChildByPath(self.Panel_base,"Image_2")
	self.Label_tip = TFDirector:getChildByPath(Image_2,"Label_tip")
    self.Label_tip:setTextById(13317149) -- 每天0点恢复3张

    self.Button_recruit_Label_btn = TFDirector:getChildByPath(self.Button_recruit,"Label_btn")
    self.Button_recruit_Label_btn:setTextById(13410003) -- 招募
--language
    Label_2:hide()
	Label_1:setTextById(13317148) -- 招募必得任意猫咪



	self.Panel_left_Label_7 = TFDirector:getChildByPath(self.Panel_left,"Label_7")
	self.Panel_left_Label_8 = TFDirector:getChildByPath(self.Panel_left,"Label_8")

    self.Panel_left_Label_7:setTextById(13317146) --招募预览
    self.Panel_left_Label_8:setTextById(13317163) --猫咪预览
...
self.Label_4:hide()
self.Label_5:hide()
		self.Label_4:setTextById(13317147) --招募中
	end
