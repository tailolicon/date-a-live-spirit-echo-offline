...
function MaokaEatFoodTip:ctor( catId )
	...
	self:init("lua.uiconfig.secondary.uiconfig_zn.activity.eatFoodTip")
end
...
function MaokaEatFoodTip:initUI( ui )
    ...
    self.Label_paiqianTip_1 = TFDirector:getChildByPath(self.Button_touwei,"Label_paiqianTip_1")
    self.Label_title:setTextById(13316890) --投喂
    self.Label_paiqianTip_1:setTextById(13316890) --投喂
