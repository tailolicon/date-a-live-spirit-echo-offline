...
function MaokaMainLayer:ctor( ... )
	...
	self:init("lua.uiconfig.secondary.uiconfig_zn.activity.maokaMainLayer")
	self:loadMap()
...
-- adventure
self.Button_adventure_Label_name  = TFDirector:getChildByPath(self.Button_adventure, "Label_name")
self.Button_adventure_Label_name1 = TFDirector:getChildByPath(self.Button_adventure, "Label_name1")
self.Button_adventure_Label_name:setTextById(13316898)
self.Button_adventure_Label_name1:setTextById(13316898)

-- shop
self.Button_shop_Label_name  = TFDirector:getChildByPath(self.Button_shop, "Label_name")
self.Button_shop_Label_name1 = TFDirector:getChildByPath(self.Button_shop, "Label_name1")
self.Button_shop_Label_name:setTextById(300965)
self.Button_shop_Label_name1:setTextById(300965)

-- maoshe
self.Button_maoshe_Label_name  = TFDirector:getChildByPath(self.Button_maoshe, "Label_name")
self.Button_maoshe_Label_name1 = TFDirector:getChildByPath(self.Button_maoshe, "Label_name1")
self.Button_maoshe_Label_name:setTextById(13316900)
self.Button_maoshe_Label_name1:setTextById(13316900)

-- make
self.Button_make_Label_name  = TFDirector:getChildByPath(self.Button_make, "Label_name")
self.Button_make_Label_name1 = TFDirector:getChildByPath(self.Button_make, "Label_name1")
self.Button_make_Label_name:setTextById(13316901)
self.Button_make_Label_name1:setTextById(13316901)

-- nvpu
self.Button_nvpu_Label_name  = TFDirector:getChildByPath(self.Button_nvpu, "Label_name")
self.Button_nvpu_Label_name1 = TFDirector:getChildByPath(self.Button_nvpu, "Label_name1")
self.Button_nvpu_Label_name:setTextById(13410021)
self.Button_nvpu_Label_name1:setTextById(13410021)

-- task
self.Button_task_Label_name  = TFDirector:getChildByPath(self.Button_task, "Label_name")
self.Button_task_Label_name1 = TFDirector:getChildByPath(self.Button_task, "Label_name1")
self.Button_task_Label_name:setTextById(1454023)
self.Button_task_Label_name1:setTextById(1454023)

-- gongshi
self.Button_gongshi_Label_name  = TFDirector:getChildByPath(self.Button_gongshi, "Label_name")
self.Button_gongshi_Label_name1 = TFDirector:getChildByPath(self.Button_gongshi, "Label_name1")
self.Button_gongshi_Label_name:setTextById(13316899)
self.Button_gongshi_Label_name1:setTextById(13316899)
self.Button_gongshi:hide()
...
function MaokaMainLayer:updateToyPanel( ... )
	...
	if not self.initToyPanel then
        ...
        self.Label_btn = TFDirector:getChildByPath(self.Button_fangzhi,"Label_btn")
        self.Label_tip  = TFDirector:getChildByPath(self.showPanel,"Label_tip")
        self.Label_tip2  = TFDirector:getChildByPath(self.showPanel,"Label_tip2")
        self.Label_tip3  = TFDirector:getChildByPath(self.showPanel,"Label_tip3")
        self.Label_tip4  = TFDirector:getChildByPath(self.showPanel,"Label_tip4")

        self.Button_show_Label_toy = TFDirector:getChildByPath(self.Button_show,"Label_toy")
        self.Button_hide_Label_toy = TFDirector:getChildByPath(self.Button_hide,"Label_toy")
        self.Button_hide_Label_toy:setTextById("玩具") --todo 玩具

        self.Button_show_Label_toy:setTextById("玩具") --todo 玩具
        self.Label_tip:setTextById(13316894)

        self.Label_tip2:setTextById(13316895)
        self.Label_tip3:setTextById(13316896)
        self.Label_tip4:setTextById(13316897)

             self.Label_btn:setTextById(13316902)
...
function MaokaMainLayer:updateToyItem( item, data )
    ...
    local Image_inScene_Label_1 =TFDirector:getChildByPath(Image_inScene,"Label_1")
    Image_inScene_Label_1:setTextById(13317164) --放置中
