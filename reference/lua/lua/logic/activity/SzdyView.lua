...
function SzdyView:initUI(ui)
	...
	self.DiceNum       = TFDirector:getChildByName(self.Dice, "DiceNum")
	self.DiceNum:setTextById(1800128)
	...
	self.RestoreTimeTag:setTextById(1800129)
	...
	self.Panel_Surprise.Panel_pray:setOpacity(0)
	local Label_pray1 = TFDirector:getChildByName(self.Panel_Surprise.Panel_pray, "Label_pray1")
	local Label_pray2 = TFDirector:getChildByName(self.Panel_Surprise.Panel_pray, "Label_pray2")
	local Label_pray3 = TFDirector:getChildByName(self.Panel_Surprise.Panel_pray, "Label_pray3")
	if Label_pray1 then 
		Label_pray1:setTextById(1800130)
	end
	if Label_pray2 then 
		Label_pray2:setTextById(1800131)
	end
	if Label_pray3 then 
		Label_pray3:setTextById(1800132)
	end
	...
	local Label_reward_tips = TFDirector:getChildByName(self.Panel_share, "Label_reward_tips")
	Label_reward_tips:setTextById(1800127)
