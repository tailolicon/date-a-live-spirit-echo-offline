...
function SnowDayMemoryLevel:initTab()
	...
	for i=1,3 do
		...
		if 	tab.data then 
			...
			TFDirector:getChildByPath(tab.panel_lab,"Label"):show():setText(Utils:MultiLanguageStringDeal(tab.data.title1))
			TFDirector:getChildByPath(tab.selectImg,"Label"):show():setText(Utils:MultiLanguageStringDeal(tab.data.title1))
			TFDirector:getChildByPath(tab.panel_lab,"Label_Right"):show():setText(Utils:MultiLanguageStringDeal(tab.data.title2))
			TFDirector:getChildByPath(tab.selectImg,"Label_Right"):show():setText(Utils:MultiLanguageStringDeal(tab.data.title2))
