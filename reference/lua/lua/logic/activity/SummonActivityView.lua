...
function SummonActivityView:initUI( ui )
    ...
    self.Image_summonActivity_1 = TFDirector:getChildByPath(ui,"Image_summonActivity_1")
    self.Image_summonActivity_2 = TFDirector:getChildByPath(ui,"Image_summonActivity_2")
...
function SummonActivityView:refreshView(  )
    ...
    elseif activityInfo.extendData.bg then 
        image_bg:setTexture(activityInfo.extendData.bg)
	end
    ...
    if not string.isNullOrEmpty(activityInfo.extendData.mask) then 
	   self.border_black:setTexture(activityInfo.extendData.mask)
        self.border_black:show()
    else
        self.border_black:hide()
    end
    
    if self.Image_summonActivity_1 then 
        self.Image_summonActivity_1:setVisible(self.activityId == 10123)
    end
    if self.Image_summonActivity_2 then 
        self.Image_summonActivity_2:setVisible(self.activityId == 10123)
    end
