...
function ActivityMainView:initData(selectActivityId,activityShowType)
    ...
    self.createModelClass_ = {
        [DEFAULT_SHOW_TYPE] ={  ---默认
            ...
            [EC_ActivityType2.DFW_AUTUMN] = requireNew("lua.logic.activity.AutumnActivityView"),  --春日祭活动入口ui暂时由AutumnActivityView改为ChunrijiActivityVIew
            ...
            [EC_ActivityType2.WAR_ORDER_2021] = requireNew("lua.logic.activity.WarOrderView"),
            ...
            [EC_ActivityType2.FULL_SERVER_TASK_ACTIVITY] = requireNew("lua.logic.activity.TaskActivityView"),
        },
        [2] = {
