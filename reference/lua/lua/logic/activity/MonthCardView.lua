...
function MonthCardView:initUI(ui)
    ...
    Utils:addDiscountLabel( self.Button_buyCard ,ccp(0,80))
    Utils:addDiscountLabel( self.Button_buyCard_ios ,ccp(0,80))
...
function MonthCardView:updateBgRes()
    ...
    self:ResolutionAdaptationNode(self.Image_bg1)
end
