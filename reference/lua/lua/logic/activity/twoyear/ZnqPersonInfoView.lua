...
function ZnqPersonInfoView:initUI(ui)
    ...
    --TODO 临时去掉
    TFDirector:getChildByPath(self.Panel_content,"Image_invite"):hide()
    TFDirector:getChildByPath(self.Panel_content,"Image_corn"):hide()
    local position = TFDirector:getChildByPath(self.Panel_content,"scroll_switch"):getPosition()
    position.y = position.y + 59
    TFDirector:getChildByPath(self.Panel_content,"scroll_switch"):setPosition(position)
