...
function DuanwuActivityView:initUI(ui)
    ...
    local Image_valentineActivityView_1 = TFDirector:getChildByPath(Image_content, "Image_valentineActivityView_1")

    if Image_valentineActivityView_1 then 
        Image_valentineActivityView_1:hide()
    end
