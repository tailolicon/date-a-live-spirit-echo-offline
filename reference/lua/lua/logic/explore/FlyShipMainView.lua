...
function FlyShipMainView:updateCabinList( ... )
	...
	for i = 1,#cabins do
		...
		if (TFLanguageMgr:getUsingLanguage() ~= cc.SIMPLIFIED_CHINESE and TFLanguageMgr:getUsingLanguage() ~= cc.TRADITIONAL_CHINESE and TFLanguageMgr:getUsingLanguage() ~= cc.VIETNAM) then
