...
function SupplyMainNewView:initData(defaultLeftIdx, pageSelectId)
    ...
    --临时屏蔽 精灵契约2
    table.insert(self.tabBtnCfg , {name = 18000330,icon = "ui/recharge/gifts/new_1/007.png", tabType = ENUM_SUPPLYS.CONTRACT2})
    -- local giftTypeList = { 21 , 22 , 23 , 24 , 25}
    -- local nameList = { 190000103 ,190000104 ,190000105 ,1650009 ,190000310}
    local giftTypeList = { 22 , 23 , 24 , 25}
    local nameList = { 190000104 ,190000105 ,1650009 ,190000310}
...
function SupplyMainNewView:selectTabIdx(idx)
    ...
    table.insert(addPageToContent , function( ... )
        self.pageViews[idx] = requireNew("lua.logic.supplyNew.ContractCardPoolView"):new()
    end)
